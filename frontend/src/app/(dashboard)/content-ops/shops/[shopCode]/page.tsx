...
export default async function ShopDetailPage({
  ...
  const shopCode = decodeURIComponent(params.shopCode)
  const { data, error } = await getShopDetail(shopCode)

  if (error === 'Shop not found') notFound()
