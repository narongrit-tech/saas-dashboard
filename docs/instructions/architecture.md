...
**Source of truth for current status:** `docs/PROJECT_STATUS.md` (updates may exist beyond this file).
...
7. **`~/.claude/plans/staged-stirring-mist.md`** (external reference)
   - Manual Column Mapping Wizard implementation plan
   - External path (not stored in this repo)
...
10. **`docs/PROJECT_STATUS.md`** ⭐ CURRENT
    - Authoritative feature status and roadmap
    - Includes updates beyond 2026-01-25

11. **`CLAUDE.md`**
    - Lightweight index of immutable rules + links to instruction docs

12. **`docs/instructions/*`**
    - Business rules, data integrity, import rules, architecture map, and workflow docs
